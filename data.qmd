...
Tabular and graphical summaries of the data provided in `Thy3000_DATA_LABELS_Raw.csv` after cleaning we can summarise the data. In total
there were `r n_observations` recorded from a total of `r n_centres`.
